...
function addScreenToPeer(peer, stream) { stream.getVideoTracks().forEach(track => { track.contentHint = 'detail'; const sender = peer.pc.addTrack(track, stream); configureScreenSender(sender); }); }
